...
// func NewNodeStore(name, account string) *NodeStore {
...
// 	if name != "" && account != "" {
// 		nodeId = GetHashKey(name, account)
// 	}

// 	enc := gob.NewEncoder(&keyBytes)
// 	enc.Encode(PrivateKey{nodeId.String(), *privateKey})
// 	file, err := os.Create(filePath)
// 	if err != nil {
// 		fmt.Println("私钥文件创建失败")
// 		return nil
// 	}
// 	file.Write(keyBytes.Bytes())
// 	file.Close()
