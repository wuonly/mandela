...
var (
	CookieName        string = "maizeSessionId"
	ProvideName       string = "file"         //session使用的存储方式
	SessionFilePath   string = "/fileSession" //fileSession文件存放目录
	SessionGCInterval int64  = 10             //SessionGC间隔时间
)
...
func NewManager() (*Manager, error) {
	...
	provider.SessionInit(SessionGCInterval, SessionFilePath)
	return &Manager{provider: provider, cookieName: CookieName, maxlifetime: SessionGCInterval}, nil
}
